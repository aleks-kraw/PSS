            ...
            <div class="container">
                <nav class="navbar navbar-light bg-light justify-content-between">
                    <div id="mySidenav" class="sidenav">
                        ...
                        <a href="{$conf->action_root}calc_kred">Kalkulator kredytowy</a>
                        <a href="{$conf->action_root}another_calc">Kalkulator powierzchni</a>
                ...
                <div class="container">
                    <div class="menu_main">
                        <div class="custome_menu">
                            <ul>
                                <li class="active"><a href="{$conf->action_root}calc_kred">Kalkulator kredytowy</a></li>
                                <li class=" active"><a href="{$conf->action_root}another_calc">Kalkulator
                                        powierzchni</a>
                                </li>
                                <li class=" active"><a href="{$conf->action_root}logout">Wyloguj</a>
                                </li>
                            </ul>
                        </div>

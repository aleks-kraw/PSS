            ...
            <div class="container">
                <nav class="navbar navbar-light bg-light justify-content-between">
                    <div id="mySidenav" class="sidenav">
                        ...
                        <a href="{$conf->app_url}/app/calc.php">Kalkulator kredytowy</a>
                        <a href="{$conf->app_url}/app/another_calc.php">Kalkulator powierzchni</a>
                ...
                <div class="container">
                    <div class="menu_main">
                        <div class="custome_menu">
                            <ul>
                                <li class="active"><a href="{$conf->app_url}/app/calc.php">Kalkulator kredytowy</a></li>
                                <li class=" active"><a href="{$conf->app_url}/app/another_calc.php">Kalkulator
                                        powierzchni</a>
                                </li>
                            </ul>
                        </div>
